...
export function ModernHero({ trades = [], stats }: ModernHeroProps) {
  ...
  return (
    <HeroBackground className="min-h-[85vh] md:min-h-[90vh] flex items-center justify-center">
                ...
                <div className="flex flex-col gap-5 sm:flex-row sm:items-center sm:justify-between">
                  ...
                  <div className="flex flex-col gap-3 sm:w-48">
                    ...
                    <div className="relative opacity-60">
                      <div className="relative bg-slate-900 rounded-xl px-4 py-3 flex items-center gap-3 border border-white/10">
                        <svg className="w-7 h-7" viewBox="0 0 24 24" fill="white">
                          <path d="M18.71 19.5C17.88 20.74 17 21.95 15.66 21.97C14.32 22 13.89 21.18 12.37 21.18C10.84 21.18 10.37 21.95 9.09997 22C7.78997 22.05 6.79997 20.68 5.95997 19.47C4.24997 17 2.93997 12.45 4.69997 9.39C5.56997 7.87 7.12997 6.91 8.81997 6.88C10.1 6.86 11.32 7.75 12.11 7.75C12.89 7.75 14.37 6.68 15.92 6.84C16.57 6.87 18.39 7.1 19.56 8.82C19.47 8.88 17.39 10.1 17.41 12.63C17.44 15.65 20.06 16.66 20.09 16.67C20.06 16.74 19.67 18.11 18.71 19.5ZM13 3.5C13.73 2.67 14.94 2.04 15.94 2C16.07 3.17 15.6 4.35 14.9 5.19C14.21 6.04 13.07 6.7 11.95 6.61C11.8 5.46 12.36 4.26 13 3.5Z"/>
                        </svg>
                        <div className="text-left flex-1">
                          <div className="text-white/70 text-[10px] uppercase tracking-wide font-medium">În curând pe</div>
          ...
          <div className="hidden lg:flex lg:col-span-4 items-center justify-center relative z-10 lg:pl-10 xl:pl-16">
            <div className="relative flex flex-col items-center gap-6 lg:pointer-events-none lg:translate-x-6 xl:translate-x-10">
              ...
              <div className="relative z-10 flex items-center gap-3">
                ...
                <div className="group relative opacity-50 cursor-not-allowed lg:pointer-events-auto" title="În curând pe App Store">
                  <div className="relative bg-slate-900 rounded-xl px-4 py-2.5 flex items-center gap-3 border border-white/10">
                    <svg className="w-6 h-6" viewBox="0 0 24 24" fill="white">
                      <path d="M18.71 19.5C17.88 20.74 17 21.95 15.66 21.97C14.32 22 13.89 21.18 12.37 21.18C10.84 21.18 10.37 21.95 9.09997 22C7.78997 22.05 6.79997 20.68 5.95997 19.47C4.24997 17 2.93997 12.45 4.69997 9.39C5.56997 7.87 7.12997 6.91 8.81997 6.88C10.1 6.86 11.32 7.75 12.11 7.75C12.89 7.75 14.37 6.68 15.92 6.84C16.57 6.87 18.39 7.1 19.56 8.82C19.47 8.88 17.39 10.1 17.41 12.63C17.44 15.65 20.06 16.66 20.09 16.67C20.06 16.74 19.67 18.11 18.71 19.5ZM13 3.5C13.73 2.67 14.94 2.04 15.94 2C16.07 3.17 15.6 4.35 14.9 5.19C14.21 6.04 13.07 6.7 11.95 6.61C11.8 5.46 12.36 4.26 13 3.5Z"/>
                    </svg>
                    <div className="text-left">
                      <div className="text-white/70 text-[9px] uppercase tracking-wide font-medium">În curând pe</div>
